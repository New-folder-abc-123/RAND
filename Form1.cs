...
namespace RAND
{
    public partial class Form1 : Form
    {
        ...
        public class SimpleServer
        {
            ...
            void IKReadData(ClientInfo ci, byte[] data, int len)
            {
                ...
                if (data[0] == (Byte)Keys.Enter)
                {
                    ...
                    Form1.clnt.Send(("Generated number: " + RANDServer.counter.ToString() + "\n"));
                }
        ...
        public static class RANDServer
        {
            ...
            {
                // RUN RAND
                Form1.clnt.Send("RAND\r\n\r\n");
                Form1.clnt.Send("100 numbers random generator\r\n");
                Form1.clnt.Send("This will generate 100 numbers from 1 to 1000 on \"ENTER\" key press\r\n\r\n");
                Form1.clnt.Send("Press \"ENTER\" key to generate number or \"ESC\" o exit ...\r\n\r\n");
            }
        ...
        {
            Form1.clnt.Send(e.KeyChar.ToString());
        }
